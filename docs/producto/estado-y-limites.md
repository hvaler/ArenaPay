...
- El repositorio y la demo están publicados, y el proyecto quedó entregado en Stellar Odyssey Perú 2026. Hay ensayos manuales v1 y v2 con dos cuentas Freighter operadas por el usuario, además de un ensayo automatizado v2 con cuentas desechables del script. El manual v2 confirma seis operaciones y una transferencia de 2 XLM de prueba a Nova. La demo final y el pitch están publicados en YouTube y archivados en el repositorio con subtítulos y huellas SHA-256. Siguen pendientes una devolución manual, recuperación integrada y la validación guiada con participantes independientes.
