...
| [Presentación inicial](media/arenapay-pitch-es.mp4), [subtítulos](media/arenapay-pitch-es.srt), [miniatura](media/arenapay-pitch-thumbnail.png) y YouTube `thcnJ7IS7fE`, ya no público | Entrega audiovisual 20-sep-2026 | [Índice audiovisual](media/README.md) | Pieza histórica de 2:44 utilizada en la entrega original |
