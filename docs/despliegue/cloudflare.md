...
Estado: publicado inicialmente el 13 de septiembre y actualizado con ArenaPay 0.4.0 el 21 de septiembre de 2026 en **<https://arenapay.arenapay.workers.dev/>**. La versión y las pruebas públicas más recientes están en la [evidencia de publicación 0.4.0](../evidencia/publicacion-0.4.0-2026-09-21.md).
